// High-Accuracy Geolocation Tracker
// Uses multiple techniques to get the most accurate location possible
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function initMap(lat, lng, accuracy) {
        ...
        // Adjust view
        map.setView([lat, lng], accuracy < 100 ? 16 : 15);
    }
    
    // Get address using the best available service
    ...
    async function getAddressFromLocationIQ(lat, lng) {
        try {
            // Note: In production, replace with a valid API key
            const response = await fetch(
